...
def fetch_media(name):
    ...
    try:
        ...
        if img and "src" in img.attrs:
            ...
            fallback_url = f"https://vogelsportugal.nl/wp-content/uploads/{slug}.jpg"
            check = requests.head(fallback_url, headers=HEADERS)
            image_url = fallback_url if check.status_code == 200 else None
